        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-white">
                Empower Your Digital Journey with Techbysj. Unleash Your
                Potential with Our Tech Services. Contact us now to Explore
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              <a
                href="https://www.tiktok.com/@_nolojia"
              ...
              <a
                href="https://www.instagram.com/_nolojia/"
                className="text-white transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
              ...
              <a
                href="https://web.facebook.com/nolojia?_rdc=1&amp;_rdr"
                className="text-white transition-colors duration-300 hover:text-deep-purple-accent-400"
              >

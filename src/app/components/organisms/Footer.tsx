    ...
    <footer>
      <div className="px-4 pt-16 bg-[#0d0452] text-white   sm:max-w-xl min-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2"><a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
            ...
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-white">Empower Your Digital Journey with Nolojia.
            ...
            </div><div className="flex"><p className="mr-1 text-white">Address:</p><a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">Ruiru near Rainbow resort</a></div>
        ...
        <div className="flex flex-col-reverse justify-center pt-5 pb-10 border-t lg:flex-row">
          <p className="text-sm text-white text-center">© Copyright 2023 Nolojia. All rights reserved.
          </p>
        </div></div>
